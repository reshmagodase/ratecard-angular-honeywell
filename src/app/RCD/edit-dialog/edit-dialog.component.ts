...
export class EditDialogComponent {
  ...
  populateData(gridItem: any){    
    ...
    this.formData.sowRate = gridItem.INRRate;
    this.formData.sowRateUSD = gridItem.USDRate;
    this.formData.newproposedinrRate = gridItem.ProposedNewINRRate;
    this.formData.newproposedusdRate = gridItem.ProposedNewUSDRate;
    this.formData.sow.proposedworkPack = gridItem.ProposedNewworkPackageName;
    this.formData.vendor.vendorName = gridItem.Vendor;
    this.formData.vendor.vendorId = gridItem.VendorId;
    this.formData.sow.rateCardId =gridItem.RateCardId;
    this.formData.sow.workPack =gridItem.WorkPackage;
    var groupId= gridItem.GroupId.split(',').map((x:any)=>parseInt(x));
    var group= gridItem.Group.split(',').map((x:any)=>x);
    this.formData.group.groupId = groupId;
    this.formData.group.groupName = group;
    this.formData.accountIndicator =gridItem.AccountIndicator
